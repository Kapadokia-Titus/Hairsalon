...
import static com.com.bestlady.ui.HomeScreenActivity.INTENT_UPDATE_LIST;
...
public class CartViewModel extends AndroidViewModel {
    ...
    public OrdersResponse submitOrders(Orders orders){
        OrdersResponse response = OrdersRepository.getInstance().submitMyOrders(getApplication().getApplicationContext(), orders);
        Log.d(TAG, "submitOrders: "+response.getMessage() );
        return response;
    }
}
